...
Namespace WSFEHOMO
    ...
    Partial Public Class Service
        ...
        Public Sub New()
            MyBase.New
            Me.Url = Global.PrototipoAfip.My.MySettings.Default.PrototipoAfip_WSFEHOMO_Service
        ...
        Public Function FEParamGetTiposPaises(ByVal Auth As FEAuthRequest) As FEPaisResponse
            Dim results() As Object = Me.Invoke("FEParamGetTiposPaises", New Object() {Auth})
            Return CType(results(0),FEPaisResponse)
        End Function
        
        '''<remarks/>
        Public Overloads Sub FEParamGetTiposPaisesAsync(ByVal Auth As FEAuthRequest)
            Me.FEParamGetTiposPaisesAsync(Auth, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub FEParamGetTiposPaisesAsync(ByVal Auth As FEAuthRequest, ByVal userState As Object)
            If (Me.FEParamGetTiposPaisesOperationCompleted Is Nothing) Then
                Me.FEParamGetTiposPaisesOperationCompleted = AddressOf Me.OnFEParamGetTiposPaisesOperationCompleted
            End If
            Me.InvokeAsync("FEParamGetTiposPaises", New Object() {Auth}, Me.FEParamGetTiposPaisesOperationCompleted, userState)
        End Sub
        
        Private Sub OnFEParamGetTiposPaisesOperationCompleted(ByVal arg As Object)
    ...
    Partial Public Class FEDetRequest
        ...
        '''<comentarios/>
        Public Property Compradores() As Comprador()
            Get
    ...
    Partial Public Class FEParamGetTiposPaisesCompletedEventArgs
        ...
        '''<remarks/>
        Public ReadOnly Property Result() As FEPaisResponse
            Get
                Me.RaiseExceptionIfNecessary
